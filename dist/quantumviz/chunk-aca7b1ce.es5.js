...
quantumviz.loadBundle("chunk-aca7b1ce.js", ["exports"], function (t) { window.quantumviz.h;
    var e = /** @class */ (function () {
        ...
        e.serializeGtsMetadata = function (t) { var e = []; return Object.keys(t.l).forEach(function (r) { "string" == typeof t.l[r] && e.push(r + "=" + t.l[r]); }), t.c + "{" + e.join(",") + "}"; };
