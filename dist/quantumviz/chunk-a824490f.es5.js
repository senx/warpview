...
quantumviz.loadBundle("chunk-a824490f.js", ["exports"], function (t) { window.quantumviz.h;
    var e = /** @class */ (function () {
        ...
        e.serializeGtsMetadata = function (t) { var e = []; return Object.keys(t.l).forEach(function (r) { e.push(r + "=" + t.l[r]); }), (t.id ? t.id + " " : "") + t.c + "{" + e.join(",") + "}"; };
