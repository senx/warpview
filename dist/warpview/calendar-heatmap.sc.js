...
import { b as Logger, d as ChartLib, a as GTSLib, c as Param, e as DataModel } from './chunk-0213d7cb.js';
...
${GTSLib.formatLabel(s.name)}: ${s.total}</li>`;
    ...
    static get style() { return "[data-calendar-heatmap-host] {\n  position: relative;\n  user-select: none;\n  -ms-user-select: none;\n  -moz-user-select: none;\n  -webkit-user-select: none; }\n  [data-calendar-heatmap-host]   .item[data-calendar-heatmap] {\n    cursor: pointer; }\n  [data-calendar-heatmap-host]   .label[data-calendar-heatmap] {\n    cursor: pointer;\n    fill: #aaaaaa;\n    font-family: Helvetica, arial, 'Open Sans', sans-serif; }\n  [data-calendar-heatmap-host]   .button[data-calendar-heatmap] {\n    cursor: pointer;\n    fill: transparent;\n    stroke-width: 2;\n    stroke: #aaaaaa; }\n  [data-calendar-heatmap-host]   .button[data-calendar-heatmap]   text[data-calendar-heatmap] {\n    stroke-width: 1;\n    text-anchor: middle;\n    fill: #aaaaaa; }\n  [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap] {\n    pointer-events: none;\n    position: absolute;\n    z-index: 9999;\n    width: 450px;\n    max-width: 650px;\n    overflow: hidden;\n    padding: 15px;\n    font-size: 12px;\n    line-height: 14px;\n    color: white;\n    font-family: Helvetica, arial, 'Open Sans', sans-serif;\n    background: rgba(0, 0, 0, 0.75); }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   ul[data-calendar-heatmap] {\n      list-style: none;\n      padding: 0; }\n      [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   ul[data-calendar-heatmap]   li[data-calendar-heatmap] {\n        padding: 0; }\n        [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   ul[data-calendar-heatmap]   li[data-calendar-heatmap]   .gtsInfo[data-calendar-heatmap] {\n          padding-left: 20px;\n          width: auto;\n          max-width: 650px; }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .header[data-calendar-heatmap]   strong[data-calendar-heatmap] {\n      display: inline-block;\n      width: 100%; }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .gts-classname[data-calendar-heatmap] {\n      color: var(--gts-classname-font-color, #0074D9); }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .gts-labelname[data-calendar-heatmap] {\n      color: var(--gts-labelname-font-color, #19A979); }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .gts-attrname[data-calendar-heatmap] {\n      color: var(--gts-labelname-font-color, #ED4A7B); }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .gts-separator[data-calendar-heatmap] {\n      color: var(--gts-separator-font-color, #bbbbbb); }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .gts-labelvalue[data-calendar-heatmap] {\n      color: var(--gts-labelvalue-font-color, #AAAAAA);\n      font-style: italic; }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .gts-attrvalue[data-calendar-heatmap] {\n      color: var(--gts-labelvalue-font-color, #AAAAAA);\n      font-style: italic; }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .round[data-calendar-heatmap] {\n      border-radius: 50%;\n      background-color: #bbbbbb;\n      display: inline-block;\n      width: 12px;\n      height: 12px;\n      border: 2px solid #454545; }\n    [data-calendar-heatmap-host]   .heatmap-tooltip[data-calendar-heatmap]   .header[data-calendar-heatmap]   strong[data-calendar-heatmap] {\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis; }"; }
}
...
class WarpViewBar {
    ...
    static get style() { return "[data-warp-view-bar-host]   div[data-warp-view-bar] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-bar-host]   .chart-container[data-warp-view-bar] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative; }"; }
}
...
class WarpViewBubble {
    ...
    static get style() { return "[data-warp-view-bubble-host]   div[data-warp-view-bubble] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-bubble-host]   .chart-container[data-warp-view-bubble] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative; }"; }
}
...
class WarpViewDisplay {
    ...
    static get style() { return "[data-warp-view-display-host]   div[data-warp-view-display] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-display-host]   .chart-container[data-warp-view-display] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative;\n  color: var(--warp-view-font-color, #000000); }\n  [data-warp-view-display-host]   .chart-container[data-warp-view-display]   div[data-warp-view-display] {\n    font-size: 10rem;\n    height: 100%;\n    width: 100%; }\n    [data-warp-view-display-host]   .chart-container[data-warp-view-display]   div[data-warp-view-display]   .value[data-warp-view-display] {\n      position: relative;\n      top: 50%;\n      -webkit-transform: translateY(-50%);\n      -ms-transform: translateY(-50%);\n      transform: translateY(-50%);\n      text-align: center;\n      height: -webkit-fit-content;\n      height: -moz-fit-content;\n      height: fit-content; }\n      [data-warp-view-display-host]   .chart-container[data-warp-view-display]   div[data-warp-view-display]   .value[data-warp-view-display]   small[data-warp-view-display] {\n        font-size: 3rem; }"; }
}
...
class WarpViewDrillDown {
    ...
    static get style() { return "[data-warp-view-drilldown-host]   .wrapper[data-warp-view-drilldown] {\n  position: relative;\n  width: 100%;\n  height: 100%; }"; }
}
...
class WarpViewImage {
    ...
    static get style() { return "[data-warp-view-image-host]   div[data-warp-view-image] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-image-host]   .chart-container[data-warp-view-image] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative; }\n  [data-warp-view-image-host]   .chart-container[data-warp-view-image]   div[data-warp-view-image] {\n    font-size: 10rem;\n    height: 100%;\n    width: 100%; }\n    [data-warp-view-image-host]   .chart-container[data-warp-view-image]   div[data-warp-view-image]   .responsive[data-warp-view-image] {\n      width: calc(100% - 10px);\n      height: auto; }"; }
}
...
class WarpViewPie {
    ...
    static get style() { return "[data-warp-view-pie-host]   div[data-warp-view-pie] {\n  width: calc(var(--warp-view-chart-width, 100%));\n  height: calc(var(--warp-view-chart-height, 100%) - 10px); }\n\n[data-warp-view-pie-host]   .chart-container[data-warp-view-pie] {\n  position: relative;\n  margin: auto; }"; }
}
...
class WarpViewPolar {
    ...
    static get style() { return "[data-warp-view-polar-host]   div[data-warp-view-polar] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-polar-host]   .chart-container[data-warp-view-polar] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative; }"; }
}
...
class WarpViewRadar {
    ...
    static get style() { return "[data-warp-view-radar-host]   div[data-warp-view-radar] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-radar-host]   .chart-container[data-warp-view-radar] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative; }"; }
}
...
class WarpViewScatter {
    ...
    static get style() { return "[data-warp-view-scatter-host]   div[data-warp-view-scatter] {\n  height: var(--warp-view-chart-height, 100%); }\n\n[data-warp-view-scatter-host]   .chart-container[data-warp-view-scatter] {\n  width: var(--warp-view-chart-width, 100%);\n  height: var(--warp-view-chart-height, 100%);\n  position: relative; }"; }
}
...
class WarpViewTile {
    ...
    static get style() { return "[data-warp-view-tile-host] {\n  --warp-view-chart-height: 100%; }\n  [data-warp-view-tile-host]   warp-view-spinner[data-warp-view-tile] {\n    position: absolute;\n    left: 0;\n    right: 0;\n    margin-left: auto;\n    margin-right: auto;\n    width: 50%;\n    top: 200px; }\n  [data-warp-view-tile-host]   .warpscript[data-warp-view-tile] {\n    display: none; }\n  [data-warp-view-tile-host]   .executionErrorText[data-warp-view-tile] {\n    color: red;\n    padding: 10px;\n    border-color: red;\n    border-width: 2px;\n    border-radius: 3px;\n    border-style: solid; }\n  [data-warp-view-tile-host]   .wrapper[data-warp-view-tile] {\n    min-height: var(--warp-view-tile-height, 400px);\n    width: var(--warp-view-tile-width, 100%);\n    height: var(--warp-view-tile-height, 100%); }\n    [data-warp-view-tile-host]   .wrapper[data-warp-view-tile]   .tile[data-warp-view-tile] {\n      width: 100%;\n      height: calc(var(--warp-view-tile-height, 100%) - 40px);\n      overflow-y: auto;\n      overflow-x: hidden; }\n    [data-warp-view-tile-host]   .wrapper[data-warp-view-tile]   h1[data-warp-view-tile] {\n      font-size: 20px;\n      padding: 5px;\n      margin: 0;\n      color: var(--warp-view-font-color, #000000); }\n      [data-warp-view-tile-host]   .wrapper[data-warp-view-tile]   h1[data-warp-view-tile]   small[data-warp-view-tile] {\n        font-size: 10px;\n        margin-left: 10px; }"; }
}
