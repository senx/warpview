...
class CalendarHeatmap {
    ...
    drawGlobalOverview() {
        ...
        const startM = this.data[0]['date'].startOf('y').utc();
        const endM = this.data[this.data.length - 1]['date'].endOf('y').utc();
    ...
    drawYearOverview() {
        ...
        // Add month labels
        const month_labels = months(start_of_year.toDate(), end_of_year.toDate());
    ...
    drawMonthOverview() {
        ...
        item_block.selectAll('.item-block-rect')
            ...
            // Calculate tooltip position
            let x = weekScale(moment.utc(date$$1).week().toString()) + this.tooltip_padding;
